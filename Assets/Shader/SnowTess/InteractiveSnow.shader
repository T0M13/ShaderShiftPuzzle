//Shader Properties: These are variables that can be adjusted in Unity's Material Inspector. 
Shader "Custom/Snow Interactive" {
	Properties{
		...
		HLSLINCLUDE
//The shader includes core, lighting, and shadow libraries from Unity's Universal Render Pipeline
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Shadows.hlsl"
//The shader includes our HLSL Tessellation Script
...
ControlPoint TessellationVertexProgram(Attributes v)
		...
		ENDHLSL
			//Defines how the shader renders its material. It specifies that it's meant for opaque objects and uses the Universal Render Pipeline.
			SubShader{
